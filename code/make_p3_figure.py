...
n = np.arange(10, 1300)
SP = 1.06  # Spearman variance factor (rank ICs)
det_b = np.tanh(SP*(za+zp)/np.sqrt(n-3))
det_n = np.tanh(SP*(zn+zp)/np.sqrt(n-3))
...
ax.scatter([116, 233], [0.460, 0.335], color="#a63d40", zorder=5, s=28)
ax.scatter([15, 30], [0.910, 0.768], color="#5b3a6e", zorder=5, s=28, marker="s")
ax.text(21, 0.90, "episode-level\n($n_{ep}$=15, 30)", fontsize=7, color="#5b3a6e")
ax.annotate("0.46", (116, 0.460), textcoords="offset points", xytext=(8, 4), fontsize=8, color="#a63d40")
ax.annotate("0.34", (233, 0.335), textcoords="offset points", xytext=(8, 4), fontsize=8, color="#a63d40")
